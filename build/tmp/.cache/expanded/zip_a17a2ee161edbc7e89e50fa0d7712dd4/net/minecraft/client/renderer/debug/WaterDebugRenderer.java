   ...
   public void render(PoseStack pPoseStack, MultiBufferSource pBufferSource, double pCamX, double pCamY, double pCamZ) {
      ...
      for(BlockPos blockpos1 : BlockPos.betweenClosed(blockpos.offset(-10, -10, -10), blockpos.offset(10, 10, 10))) {
         ...
         if (fluidstate.is(FluidTags.WATER)) {
            ...
            DebugRenderer.renderFilledBox(pPoseStack, pBufferSource, (new AABB((double)((float)blockpos1.getX() + 0.01F), (double)((float)blockpos1.getY() + 0.01F), (double)((float)blockpos1.getZ() + 0.01F), (double)((float)blockpos1.getX() + 0.99F), d0, (double)((float)blockpos1.getZ() + 0.99F))).move(-pCamX, -pCamY, -pCamZ), 0.0F, 1.0F, 0.0F, 0.15F);
         }
      }
      ...
      for(BlockPos blockpos2 : BlockPos.betweenClosed(blockpos.offset(-10, -10, -10), blockpos.offset(10, 10, 10))) {
         ...
         if (fluidstate1.is(FluidTags.WATER)) {
            DebugRenderer.renderFloatingText(pPoseStack, pBufferSource, String.valueOf(fluidstate1.getAmount()), (double)blockpos2.getX() + 0.5D, (double)((float)blockpos2.getY() + fluidstate1.getHeight(levelreader, blockpos2)), (double)blockpos2.getZ() + 0.5D, -16777216);
         }
      }

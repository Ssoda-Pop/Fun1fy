...
public class MoveToSkySeeingSpot {
   ...
   @Nullable
   private static Vec3 getOutdoorPosition(ServerLevel p_23565_, LivingEntity pLevel) {
      RandomSource randomsource = pLevel.getRandom();
      BlockPos blockpos = pLevel.blockPosition();

      for(int i = 0; i < 10; ++i) {
         BlockPos blockpos1 = blockpos.offset(randomsource.nextInt(20) - 10, randomsource.nextInt(6) - 3, randomsource.nextInt(20) - 10);
         if (hasNoBlocksAbove(p_23565_, pLevel, blockpos1)) {

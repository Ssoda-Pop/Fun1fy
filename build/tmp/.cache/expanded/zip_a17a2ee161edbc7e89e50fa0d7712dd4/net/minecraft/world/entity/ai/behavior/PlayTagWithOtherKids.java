...
public class PlayTagWithOtherKids {
   ...
   private static boolean isFriendChasingMe(LivingEntity p_23642_, LivingEntity pEntity) {
      return pEntity.getBrain().getMemory(MemoryModuleType.INTERACTION_TARGET).filter((p_23661_) -> {

...
public class ValidateNearbyPoi {
   ...
   private static boolean bedIsOccupied(ServerLevel p_24531_, BlockPos pLevel, LivingEntity pPos) {
      BlockState blockstate = p_24531_.getBlockState(pLevel);
      return blockstate.is(BlockTags.BEDS) && blockstate.getValue(BedBlock.OCCUPIED) && !pPos.isSleeping();
   }
}
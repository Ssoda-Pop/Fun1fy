...
public class Allay extends PathfinderMob implements InventoryCarrier, VibrationSystem {
   ...
   public float getHoldingItemAnimationProgress(float pHoldingItemAnimationProgress) {
      return Mth.lerp(pHoldingItemAnimationProgress, this.holdingItemAnimationTicks0, this.holdingItemAnimationTicks) / 5.0F;
   }
   ...
   public float getSpinningProgress(float pSpinningProgress) {
      return Mth.lerp(pSpinningProgress, this.spinningAnimationTicks0, this.spinningAnimationTicks) / 15.0F;
   }

...
public class Warden extends Monster implements VibrationSystem {
   ...
   public static void applyDarknessAround(ServerLevel pLevel, Vec3 pPos, @Nullable Entity p_219378_, int pRadius) {
      MobEffectInstance mobeffectinstance = new MobEffectInstance(MobEffects.DARKNESS, 260, 0, false, false);
      MobEffectUtil.addEffectToPlayersAround(pLevel, p_219378_, pPos, (double)pRadius, mobeffectinstance, 200);
   }
